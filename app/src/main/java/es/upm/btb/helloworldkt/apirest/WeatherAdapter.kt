...
class WeatherAdapter(private var weatherList: List<es.upm.btb.helloworldkt.entities.List>):
    ...
    fun updateWeatherData(newWeatherList: List<es.upm.btb.helloworldkt.entities.List>) {
